 ...
 * @author LinuxPhantom
 * @source https://github.com/LinuxPhantom/DiscordChannelSpy
 * @description A plugin which displays all hidden Channels, which can't be accessed due to Role Restrictions.
*/
...
const config = {
  info: {
    ...
    description: "A plugin which displays all hidden Channels, which can't be accessed due to Role Restrictions.",
    version: "0.3.1",
    github: "https://github.com/LinuxPhantom/DiscordChannelSpy"
  },
  ...
  changelog: [
    {
      title: "v0.9.2",
      items: [
        "Fixed Connector With Better Discord"
      ]
    }
  ],
...
class Dummy {
  ...
  getSettingsPanel () {
    ...
    const buttonClicker = document.createElement("ChannelSpy");
